...
?>
    ...
    <form action="" method="post">
        <table id="myTable">
            ...
            <tr>
                <td></td>
                <td>(ক) ক্যাশে নগদ জমা align="center" valign="middle" bgcolor="#BEEA93"</td>
                <td><input type="text" id="txt1"    name="cbscashdeposit" align="right" bgcolor="#BEEA93" onkeyup="sum();"></td>
            </tr>
            <tr>
                <td></td>
